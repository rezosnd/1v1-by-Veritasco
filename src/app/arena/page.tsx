      ...
      <main className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 w-full max-w-3xl mx-auto pointer-events-none">
        <div className="pointer-events-auto w-full flex flex-col items-center">
          ...
          >
            ...
            />
            <button onClick={playClickSound} className="notify-btn w-full sm:w-auto px-8 py-3.5 sm:py-4 rounded-xl btn-epic text-white font-bold hover:opacity-90 transition-opacity whitespace-nowrap text-sm sm:text-base shadow-[0_0_20px_rgba(171,130,235,0.4)]">
              Notify Me
            </button>
          </motion.div>
